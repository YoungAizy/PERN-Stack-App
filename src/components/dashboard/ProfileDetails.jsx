  ...
  return (
    <div >
        ...
        <form action="" method="post">
          ...
          <TextInput label="Username" inputId="username" val={username} inputType="text" onChangeEvent={setUsername} fieldName="user_name" additionalClasses={inputClasses} />
          <TextInput label={"City"} inputId={"city"} val={city} inputType={"text"} fieldName={"city"} onChangeEvent={setCity} additionalClasses={inputClasses} />
